...
public class ContaCorrenteTest {
	...
	public void testDepositar() {
		//CENÁRIO 
		ContaCorrente cc = new ContaCorrente("Kleber");
	...
	public void testSacarSaldoSuficiente() {
		...
		public void testSacarSaldoInsuficiente() {
			...
			ContaCorrente cc = new ContaCorrente("Ruan", 0);
			...
			public void testTransferir() {
				...
				//CENÁRIO 
				ContaCorrente conta1 = new ContaCorrente("A", 300);
				ContaCorrente conta2 = new ContaCorrente("A", 0);
